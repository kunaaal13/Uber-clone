...
const Search = () => {
  ...
  return (
    <Wrapper>
      ...
      <Link href={{ pathname: '/Confirm', query: { pickup: pickup, dropoff: dropoff } }} passHref>
...
const ConfirmButtonContainer = tw.div`bg-black text-white flex justify-center mx-4 my-2 py-3 text-2xl 
cursor-pointer`;
